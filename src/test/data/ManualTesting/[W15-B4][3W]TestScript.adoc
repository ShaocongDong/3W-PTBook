...
As our applcation consists of one address book and one task book, and our separate storage of tasks and contacts, we have put the sample address book xml file and task book xml file inside the same folder named `[W15-B4][3W]SampleData` and zipped it for submission. +

. Unzip the sample data zip into a new folder. You can see a new folder called `[W15-B4][3W]SampleData`.
. Put the Jar file into this folder called `[W15-B4][3W]SampleData`.
. Open this folder, you can also see a folder called data, this is the folder where our manual test data are.
...
==== findTask command +
`findTask picnic/demo/meeting` +
You can see there are three tasks listed, all of them are common test cases used by developers of this team.
